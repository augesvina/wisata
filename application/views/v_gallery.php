        ...
        <div class="container-fluid">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    ...
                    <li  class="menu-active"><a href="<?php echo base_url() . 'Gallery' ?>">Gallery</a></li>
        ...
        <section id="fasilitas" class="section-bg">
            <div class="container">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="<?php echo base_url() . 'theme/images/grape 5.jpg' ?>" class="img-fluid" alt="" data-lightbox="portfolio" data-title="App 1" class="link-preview" title="Preview"><i
                                        class="ion ion-eye"></i></a>
                            </figure>
                                </div>
                        <div class="carousel-container">
