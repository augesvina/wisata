        ...
        <div class="container-fluid">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    ...
                    <li class="menu-active"><a href="<?php echo base_url() . 'Tiket' ?>">Tiket</a></li>
            ...
            <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active">
                        <div class="carousel-background"><img src="<?php echo base_url() . 'theme/images/grape4.jpg' ?>"
                                alt=""></div>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-background"><img src="<?php echo base_url() . 'theme/images/grape 5.jpg' ?>"
                                alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2>tiket</h2>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-background"><img src="<?php echo base_url() . 'theme/images/grape 7.jpg' ?>"
                                alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2>tiket</h2>
...
<br><img src="<?= base_url('assets/images/tiket.jpg') ?>" alt=""><br>
...
<section id="about">
            <div class="container">
        <section id="fasilitas" class="section-bg">
            <div class="container">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="<?php echo base_url() . 'theme/images/grape 5.jpg' ?>" class="img-fluid" alt="" data-lightbox="portfolio" data-title="App 1" class="link-preview" title="Preview"></a>
                            </figure>
                                </div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                ...
                <div class="row contact-info">
                    ...
                    <div class="col-md-4">
                        <div class="contact-address">
                            ...
                            <h3>Address</h3>
                            <address>Kare Madiun Jawa Timur</address>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="contact-phone">
                            ...
                            <h3>Phone Number</h3>
                            <p><a href="tel:+62 000111223333">+62 000111223333</a></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="contact-email">
                            ...
                            <h3>Email</h3>
                            <p><a href="mailto:maganghore@gmail.com">maganghore@gmail.com</a></p>
                        </div>
                    </div>
  ...
  ============================-->
    <footer id="footer">
        ...
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong>PORTAL WISATA KARE </strong>. All Rights Reserved
            </div>
